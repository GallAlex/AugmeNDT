...
namespace AugmeNDT
{
    public static class GradientUtils
    {
        ...
        /// <summary>
        /// Projects gradients onto a plane defined by a rectangle and normalizes them.
        ...
        /// <returns>A list of normalized gradient points.</returns>
        public static List<GradientDataset> NormalizeGradientsToRectangle(List<GradientDataset> generatedGradientPoints, Vector3[] rectangleCorners)
        {
            ...
            // Project each gradient onto the rectangle plane
            foreach (var point in generatedGradientPoints)
            {
            ...
            Debug.Log("Gradients have been projected onto the rectangle plane and normalized.");
            return generatedGradientPoints;
        }
    }
}
