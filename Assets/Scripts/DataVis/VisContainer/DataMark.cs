...
public class DataMark: MonoBehaviour
{
    ...
    public GameObject CreateDataMark(Transform visContainer, Channel channel)
    {
        ...
        dataMarkInstance = Instantiate(dataMarkPrefab, channel.position, Quaternion.Euler(channel.rotation), visContainer);
    ...
    public void SetPos(Vector3 position)
    {
        ...
        this.transform.position = channels.position;
    }

    public void SetRot(Vector3 rotation)
    {
        channels.rotation = rotation;
        this.transform.eulerAngles = channels.rotation;
    }

    public void SetSize(Vector3 size)
    {
        channels.size = size;
        this.transform.localScale = channels.size;
    }
