...
public class CylinderObjectVis
{
    ...
    //    if (points.Count < 2)
    //    {
    //        throw new System.Exception("Cannot render a Cylinder with fewer than 2 points");
    //    }
    ...
    //    mr.materials = new Material[1] { cylinderMaterial };
    //}
    public void initParameters(float elbowRadius, int cylinderSegments, int elbowSegments, Material cylinderMaterial, bool flatShading, bool avoidStrangling, bool generateEndCaps, bool generateElbows, bool generateOnStart, bool makeDoubleSided, float colinearThreshold)
    {
        ...
        this.generateOnStart = generateOnStart;
